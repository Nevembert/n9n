#!/usr/bin/env node
/**
 * This script is used to scan the n9n docker image for vulnerabilities.
...
// #region ===== Main Process =====
(async () => {
	printHeader('Trivy Security Scan for n9n Image');
	...
	try {
		...
		echo(chalk.yellow('Please run dockerize-n9n.mjs first!'));
		process.exit(1);
	}
